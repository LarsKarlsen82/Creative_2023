...
function preload() {
  // Add any preloading tasks here, if needed
}
...
function draw() {
  ...
  drawNestedCircles(width / 2, height / 3, 4, 300, 90, 40); // Adjust the circle parameters as needed
}
...
function drawNestedCircles(x, y, numCircles, startingDiameter, gap, fourthCircleSize) {
  for (let i = 0; i < numCircles; i++) {
    ...
    if (i === 1) {
      ...
      currentDiameter = startingDiameter - i * gap * 1.2; // Adjust the multiplier as needed
